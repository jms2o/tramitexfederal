  ...
  return <div className="mx-auto max-w-4xl motion-safe:animate-[module-enter_.22s_ease-out]">
    ...
    <div className="card p-6 sm:p-8">
      ...
      <form className="mt-8 grid gap-5 sm:grid-cols-2" onSubmit={submit}>
        <label className="field">Nombre completo<div className="relative"><UserRound className="pointer-events-none absolute left-3 top-1/2 -translate-y-1/2 text-slate-400" size={17} /><input className="input input-with-icon" name="fullName" defaultValue={fullName} required /></div></label>
        <label className="field">Correo electrónico<div className="relative"><Mail className="pointer-events-none absolute left-3 top-1/2 -translate-y-1/2 text-slate-400" size={17} /><input className="input input-with-icon" type="email" name="email" defaultValue={client.email ?? ""} required /></div></label>
        <label className="field">Teléfono<div className="relative"><Phone className="pointer-events-none absolute left-3 top-1/2 -translate-y-1/2 text-slate-400" size={17} /><input className="input input-with-icon" name="phone" defaultValue={client.phone ?? ""} required /></div></label>
